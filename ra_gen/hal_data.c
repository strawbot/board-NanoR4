...
gpt_instance_ctrl_t prescalar_ctrl;
#if 0
const gpt_extended_pwm_cfg_t prescalar_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t prescalar_extend =
{
...
#if 0
    .p_pwm_cfg                   = &prescalar_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t prescalar_cfg =
{
    .mode                = TIMER_MODE_PERIODIC,
    /* Actual period: 0.0001 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0xc80, .duty_cycle_counts = 0x640, .source_div = (timer_source_div_t)0,
    .channel             = 3,
    .p_callback          = NULL,
...
const timer_instance_t prescalar =
{
    .p_ctrl        = &prescalar_ctrl,
    .p_cfg         = &prescalar_cfg,
    .p_api         = &g_timer_on_gpt
};
gpt_instance_ctrl_t delta_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t delta_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t delta_timer_extend =
{
    .gtioca = { .output_enabled = false,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
    ...
    .capture_filter_gtiocb       = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &delta_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
/* Instance structure to use this module. */
const timer_instance_t delta_timer =
{
    .p_ctrl        = &delta_timer_ctrl,
    .p_cfg         = &delta_timer_cfg,
    .p_api         = &g_timer_on_gpt
};
gpt_instance_ctrl_t tick_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t tick_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t tick_timer_extend =
{
    .gtioca = { .output_enabled = false,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
    ...
    .capture_filter_gtiocb       = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &tick_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
/* Instance structure to use this module. */
const timer_instance_t tick_timer =
{
    .p_ctrl        = &tick_timer_ctrl,
    .p_cfg         = &tick_timer_cfg,
    .p_api         = &g_timer_on_gpt
};
